...
def weights_distribution_histogram(path_analysis_dir, path_info_dir):
    ...
    inf_weight_dict, plots_dir, dict_param, animal_name = dict_transformed_inferred_weights(path_analysis_dir, path_info_dir, dict_param=0, dict_processed_objects=0)
